...
<head>
    ...
    <link rel="alternate" type="application/json+oembed"
        href="wp-json/oembed/1.0/embed17b5.json?url=https%3A%2F%2Fdemo.spoonthemes.net%2Fthemes%2Fadifier%2F" />
    <link rel="alternate" type="text/xml+oembed"
        href="wp-json/oembed/1.0/embede6b2?url=https%3A%2F%2Fdemo.spoonthemes.net%2Fthemes%2Fadifier%2F&amp;format=xml" />
            ...
            <div class="flex-wrap">
                ...
                <div class="navigation-wrap">
                    <ul class="navigation list-inline list-unstyled">
                        <li id="menu-item-15"
                            class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-10 current_page_item menu-item-has-children menu-item-15 dropdown ">
                            <a title="Home" href="{{ route('/')}}" data-toggle="dropdown" class="dropdown-toggle"
                                data-hover="dropdown" aria-haspopup="true">Home </a>

                        </li>
                        <li id="menu-item-17"
                            class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-17 dropdown ">
                            <a title="Buy Books" href="{{ route('login')}}" data-toggle="dropdown"
                                class="dropdown-toggle" data-hover="dropdown" aria-haspopup="true">Buy Books </a>
                        </li>
                        <li id="menu-item-144"
                            class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-144 dropdown ">
                            <a title="Sell Books" href="{{ route('login')}}" data-toggle="dropdown"
                                class="dropdown-toggle" data-hover="dropdown" aria-haspopup="true">Sell Books</a>

                        </li>
                        </li>
                        <li id="menu-item-144"
                            class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-144 dropdown ">
                            <a title="Career" href="{{ route('login')}}" data-toggle="dropdown" class="dropdown-toggle"
                                data-hover="dropdown" aria-haspopup="true">Career</a>

                        </li>

                        <li id="menu-item-273"
                            class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-273 dropdown ">
                            ...
                            <ul role="menu" class=" dropdown-menu">
                                <li id="menu-item-365"
                                    class="menu-item menu-item-type-post_type menu-item-object-page menu-item-365"><a
                                        title="All Categories" href="all-categories/index.html">Post Blogs</a>
                                </li>
                                <li id="menu-item-365"
                                    class="menu-item menu-item-type-post_type menu-item-object-page menu-item-365"><a
                                        title="All Categories" href="all-categories/index.html">View Blogs</a>
                                </li>
                            </ul>
                        </li>
                        <li id="menu-item-14"
                            class="menu-item menu-item-type-post_type menu-item-object-page menu-item-14"><a
                                title="Contact" href="{{ route('contactus')}}">Contact</a></li>
                        <li id="menu-item-14"
                            class="menu-item menu-item-type-post_type menu-item-object-page menu-item-14"><a
                                title="login" href="{{ route('login')}}">login</a></li>
                        <li id="menu-item-14"
                            class="menu-item menu-item-type-post_type menu-item-object-page menu-item-14"><a
                                title="signup" href="{{ route('signup')}}">signup</a></li>
                    </ul>
                </div>
